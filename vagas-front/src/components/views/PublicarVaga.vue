<template>
  <div class="container py-4">
    <div class="row">
      <div class="col">
        <h4>Apresente sua vaga de graça!</h4>
      </div>
    </div>
    ...
    <div class="row mt-3">
      ...
      <div class="col">
        ...
        <div class="form-text">Infome onde as atividades serão realizadas.</div>
      </div>
      ...
      <div class="col">
        ...
        <div class="form-text">Infome tipo de contrato.</div>
      </div>
      <div class="row mt-3">
        <div class="col">
...
export default {
  ...
  methods: {
    salvarVaga() {
     ...
     // console.log(vagas); // converte String em objeto
